        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShoppingName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ShoppingDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ShoppingDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IsShoppingComplate = table.Column<bool>(type: "bit", nullable: false),
                    ComplateDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShoppingLists", x => x.ShoppingId);
                    table.ForeignKey(
