...
namespace NumberconversionServiceReferance
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://www.dataaccess.com/webservicesserver/", ConfigurationName="NumberconversionServiceReferance.NumberConversionSoapType")]
    public interface NumberConversionSoapType
    {
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<NumberconversionServiceReferance.NumberToWordsResponse> NumberToWordsAsync(NumberconversionServiceReferance.NumberToWordsRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<NumberconversionServiceReferance.NumberToDollarsResponse> NumberToDollarsAsync(NumberconversionServiceReferance.NumberToDollarsRequest request);
    }
    ...
    public partial class NumberToWordsRequest
    {
        ...
        public NumberconversionServiceReferance.NumberToWordsRequestBody Body;
        
        public NumberToWordsRequest()
        {
        }
        
        public NumberToWordsRequest(NumberconversionServiceReferance.NumberToWordsRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class NumberToWordsResponse
    {
        ...
        public NumberconversionServiceReferance.NumberToWordsResponseBody Body;
        
        public NumberToWordsResponse()
        {
        }
        
        public NumberToWordsResponse(NumberconversionServiceReferance.NumberToWordsResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class NumberToDollarsRequest
    {
        ...
        public NumberconversionServiceReferance.NumberToDollarsRequestBody Body;
        
        public NumberToDollarsRequest()
        {
        }
        
        public NumberToDollarsRequest(NumberconversionServiceReferance.NumberToDollarsRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class NumberToDollarsResponse
    {
        ...
        public NumberconversionServiceReferance.NumberToDollarsResponseBody Body;
        
        public NumberToDollarsResponse()
        {
        }
        
        public NumberToDollarsResponse(NumberconversionServiceReferance.NumberToDollarsResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    public interface NumberConversionSoapTypeChannel : NumberconversionServiceReferance.NumberConversionSoapType, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    public partial class NumberConversionSoapTypeClient : System.ServiceModel.ClientBase<NumberconversionServiceReferance.NumberConversionSoapType>, NumberconversionServiceReferance.NumberConversionSoapType
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<NumberconversionServiceReferance.NumberToWordsResponse> NumberconversionServiceReferance.NumberConversionSoapType.NumberToWordsAsync(NumberconversionServiceReferance.NumberToWordsRequest request)
        {
            return base.Channel.NumberToWordsAsync(request);
        }
        
        public System.Threading.Tasks.Task<NumberconversionServiceReferance.NumberToWordsResponse> NumberToWordsAsync(ulong ubiNum)
        {
            NumberconversionServiceReferance.NumberToWordsRequest inValue = new NumberconversionServiceReferance.NumberToWordsRequest();
            inValue.Body = new NumberconversionServiceReferance.NumberToWordsRequestBody();
            inValue.Body.ubiNum = ubiNum;
            return ((NumberconversionServiceReferance.NumberConversionSoapType)(this)).NumberToWordsAsync(inValue);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<NumberconversionServiceReferance.NumberToDollarsResponse> NumberconversionServiceReferance.NumberConversionSoapType.NumberToDollarsAsync(NumberconversionServiceReferance.NumberToDollarsRequest request)
        {
            return base.Channel.NumberToDollarsAsync(request);
        }
        
        public System.Threading.Tasks.Task<NumberconversionServiceReferance.NumberToDollarsResponse> NumberToDollarsAsync(decimal dNum)
        {
            NumberconversionServiceReferance.NumberToDollarsRequest inValue = new NumberconversionServiceReferance.NumberToDollarsRequest();
            inValue.Body = new NumberconversionServiceReferance.NumberToDollarsRequestBody();
            inValue.Body.dNum = dNum;
            return ((NumberconversionServiceReferance.NumberConversionSoapType)(this)).NumberToDollarsAsync(inValue);
        }
